...
export const metadata = {
  ...
  alternates: {
    canonical: "https://www.spirehubs.com/services",
  },
  ...
  openGraph: {
    ...
    description:
      "SpireHubs offers end-to-end web mobile application development services such as business needs & requirements analysis & custom design architecture .",
    url: "https://www.spirehubs.com/services",
    siteName: "SpireHub",
    locale: "en_US",
    type: "website",
  },
  ...
  return (
    <div className="mt-[-88px] mb-[90px]">
      <HeroSection
        ...
        secondaryImage="/images/services/service-secondary.png"
      >
        <PageTitle>
          <span className="text-[#f57E32]">Services</span>
        </PageTitle>
